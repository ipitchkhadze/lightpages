...
<div class="col-md-12">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">{{trans('lightpages::lightpages.pages_list')}}</h3>&nbsp;&nbsp;&nbsp; <a class="btn btn-sm btn-primary" href="{{route('pages.create')}}"><i class="fa fa-plus"></i></a>
        </div>
        <div class="box-body">
            <div class="table-responsive">
                <table class="table table-striped table-bordered" id="pages-table">
                    <thead>
                        <tr>
                            <th>id</th>
                            <th>{{trans('lightpages::lightpages.page_name')}}</th>
                            <th>{{trans('lightpages::lightpages.page_title')}}</th>
                            <th>{{trans('lightpages::lightpages.page_url')}}</th>
                            <th>{{trans('lightpages::lightpages.page_lang')}}</th>
